...
class ScopeAuthorizationService
{
    ...
    private const ADMIN_PERMISSION_TO_SCOPES = [
        ...
        'recharges:details' => ['recharges_admin.read'],
        'recharges:create' => ['recharges_admin.create'],
        'recharges:complete' => ['recharges_admin.complete'],
        'recharges:cancel' => ['recharges_admin.cancel'],
        'recharges:fail' => ['recharges_admin.fail'],
        'transfers:view' => ['transfers_admin.read'],
        'transfers:details' => ['transfers_admin.read'],
        'transfers:create' => ['transfers_admin.create'],
        'transfers:process' => ['transfers_admin.process'],
        'transfers:cancel' => ['transfers_admin.cancel'],
        'invoices:view' => ['invoices_admin.read'],
        'invoices:details' => ['invoices_admin.read'],
        'invoices:create' => ['invoices_admin.create'],
        'invoices:pay' => ['invoices_admin.pay'],
        'invoices:cancel' => ['invoices_admin.cancel'],
        'invoices:refund' => ['invoices_admin.refund'],
        'invoices:summary' => ['invoices_admin.read'],
